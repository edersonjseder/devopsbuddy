...
//        List<String> tokensAsList = tokens.stream().map(passwordResetToken -> passwordResetToken.getToken()).collect(Collectors.toList());
//        List<String> actualTokensAsList = actualTokens.stream().map(passwordResetToken -> passwordResetToken.getToken()).collect(Collectors.toList());
//
